...
from agentq_lib.common import AgentQError, bound_output
...
def _record_delivery(
    ...
    """
    from agentq_lib.state import store_receipt
...
def emit_cached(
    ...
    return emit(args, data, formatter, root=root)
