...
from agentq_lib.common import AgentQCancelled  # noqa: E402
from agentq_lib.contracts.execution import (  # noqa: E402
    CaptureStatus,
    CleanupStatus,
    ExecutionOutcome,
    ExecutionSpec,
...
from agentq_lib.process import (  # noqa: E402
    CancellationToken,
    cli_exit_code,
...
class AdapterCancellationTests(SupervisorTestCase):
    ...
    def test_run_cmd_cancellation_raises_with_shell_code(self) -> None:
        from agentq_lib.common import run_cmd
...
class RunCompactFailureTests(SupervisorTestCase):
    def test_capture_failure_is_a_wrapper_error_with_detail(self) -> None:
        from agentq_lib import process as process_module
        from agentq_lib.runops import run_compact
