...
from agentq_lib.contracts._base import ContractError  # noqa: E402
...
class ArtifactStorageTests(unittest.TestCase):
    ...
    def test_artifact_round_trip_size_limit_and_expiry(self) -> None:
        with mock.patch.dict(os.environ, self.env, clear=False):
            from agentq_lib import continuations
    ...
    def test_disabled_context_storage_keeps_a_literal_display_command(self) -> None:
        ...
        with mock.patch.dict(os.environ, env, clear=False):
            from agentq_lib import continuations
            from agentq_lib.contracts.request import DiffSelection
            from agentq_lib.requests import request_for
    ...
    def test_artifact_page_cursor_dispatches_through_the_page_handler(self) -> None:
        ...
        with mock.patch.dict(os.environ, env, clear=False):
            from agentq_lib import continuations
            from agentq_lib.cli.commands import navigation as navigation_commands
...
class ContinuationRecordTests(unittest.TestCase):
    ...
    def test_corrupt_or_unknown_payload_fails_explicitly(self) -> None:
        with mock.patch.dict(os.environ, self.env, clear=False):
            from agentq_lib import continuations, state
    ...
    def test_refinement_must_match_the_operation(self) -> None:
        from agentq_lib import continuations
        from agentq_lib.contracts.request import SearchOptions
        from agentq_lib.requests import request_for
